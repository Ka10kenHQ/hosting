        ...
        <div class="app">
            <header class="site-header">
                ...
                <nav class="site-nav" aria-label="Primary navigation">
                    ...
                    <Link<Route> to={Route::Project { name: "watchclean".to_string() }}>{"Projects"}</Link<Route>>
                    <a href="https://github.com/Ka10ken1" target="_blank">{"GitHub"}</a>
                    <a href="mailto:matekopaliani12@gmail.com">{"Contact"}</a>
                </nav>
            </header>
            <main>
                <RouterBody />
